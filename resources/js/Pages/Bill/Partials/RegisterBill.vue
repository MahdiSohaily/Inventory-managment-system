<template>
    <jet-form-section @submitted="RegisterBill">
        ...
        <template #description>
            برای ثبت بیل خریداری فورم ذیل بروزرسانی نمایید.
        </template>
...
<script>
    ...
    export default defineComponent({
        ...
        data() {
            return {
                form: this.$inertia.form({
                    ...
                    shop_id: this.purchase[0].shop_id,
                    good_name: this.purchase[0].good_name,
                    seller: this.purchase[0].name,
                    quantity: this.purchase[0].quantity,
                    value: this.purchase[0].price_per,
                    proc_id: null,
                    date: null,
                    description: null,
                }),
        ...
        methods: {
            RegisterBill() {
                this.form.post(route('bill.create'), {
                    preserveScroll: true,
                    onSuccess: () => {
