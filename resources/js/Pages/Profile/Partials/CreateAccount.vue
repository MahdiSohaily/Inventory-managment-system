<template>
    <jet-form-section @submitted="createAccount">
        ...
        <template #form>
            <div class="row pb-2">
                ...
                <div class="col-md-4">
                    ...
                    <select id="c.position" class="form-control" v-model="form.position" required>
                        ...
                        <option value="معتمد جنسی">معتمد جنسی</option>
            ...
            <div class="row pb-2">
                <div class="col-md-4">
                    <jet-label for="c.boss" value="ریاست"/>
                    <jet-input id="c.boss" type="text" class=" form-control" v-model="form.boss" required/>
                    <jet-input-error :message="form.errors.boss" class="mt-2"/>
                </div>
                <div class="col-md-4">
                    <jet-label for="c.section" value="آمریت"/>
                    <jet-input id="c.section" type="text" class="form-control" v-model="form.section" required/>
